...
- (void)_createSearchView {
    ...
    UIView *cell = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kScreenHeight, 50)];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    _textField.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.2];
    _textField.text = @"搜索菜谱、专辑、豆友";
    
    _textField.leftView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ico_cell_search"]];
    _textField.leftView.frame = CGRectMake(5, 5, 20, 20);
    _textField.textColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:1];
    _textField.borderStyle = UITextBorderStyleRoundedRect;
    _textField.layer.borderColor = (__bridge CGColorRef _Nullable)([UIColor whiteColor]);
...
- (void)textFieldDidBeginEditing:(UITextField *)textField {
    ...
    [self.ViewController presentViewController:search animated:YES completion:NULL];
}
...
//
    if (y > 50) {
        cell.backgroundColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:y / 156.0];
        
        view.backgroundColor = [UIColor colorWithRed:128/255.0 green:128/255.0 blue:128/255.0 alpha:y / 156.0];
    }
