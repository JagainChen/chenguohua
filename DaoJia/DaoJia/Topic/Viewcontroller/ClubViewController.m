...
- (void)viewDidLoad {
    ...
    topicTableView = [[TopicTableView alloc] initWithFrame:CGRectMake(0, 44, kScreenWidth, kScreenHeight-44- 48) style:UITableViewStyleGrouped];
    peopleTableView = [[PeopleTableView alloc] initWithFrame:CGRectMake(0, 44, kScreenWidth, kScreenHeight-44- 48) style:UITableViewStylePlain];
